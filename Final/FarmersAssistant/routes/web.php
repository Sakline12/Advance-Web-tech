...
Route::get('/reactplan', function () {
    return view('Reactplan');
});

Route::get('/reactproduct', function () {
    return view('Reactproduct');
});

Route::get('/reactplancreate', function () {
    return view('Reactplancreate');
});

Route::get('/react/productedit/{id}', function () {
    return view('Reactproductedit');
});
...
Route::get('/reactproductcreate', function () {
    return view('reactproductcreate');
});
