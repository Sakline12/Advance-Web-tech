...
class productsCreateController extends Controller
{
    ...
    public function goproductupdate(Request $request)
    {
        ...
        public function producteditapi($id)
        {
            return Product::find($id);

        }

        public function productupdateapi(Request $request)
        {
            //
        ...
        public function deleteproductsapi($id)
        {
            $product=Product::where('id',$id)->delete();
            if($product)
            {
                return ["product"=>"product is delete"];
            }
            else
            {
                return["product"=>"product is not delete"];
            }
        }
